...
concat({
	...
	dest : 'build/backbone.input.scroll.js'
});


// - Validate js
lint('build/backbone.input.scroll.js', function(){

	// - Create / save minified file
	uglify('build/backbone.input.scroll.js', 'build/backbone.input.scroll-min.js');
